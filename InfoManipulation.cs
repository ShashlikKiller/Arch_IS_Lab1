...
namespace Arch_IS_Lab1
{
    public class InfoManipulation
    {
        ...
        {
            uint searchID = uint.Parse(Console.ReadLine()); // СДЕЛАТЬ ПРОВЕРКУ НА ИНТ
        ...
        public static void AddNewRecord(List<Student> Students)
        {
            ...
            string varname = FoolCheck.StringCheck();
            Console.WriteLine(" Введите фамилию: ");
            string varsurname = FoolCheck.StringCheck();
            Console.WriteLine(" Введите название группы: ");
            string vargroup = FoolCheck.StringCheck();
            Console.WriteLine(" Введите ID студента: ");
            uint varstudent_id = FoolCheck.IntCheck(); // Сделать проверку на дурака
            Console.WriteLine(" Введите статус обучения (1 - Да, 2 - Нет): ");
            bool varlearningstatus = FoolCheck.BoolCheck();
